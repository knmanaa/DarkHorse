...
window.DarkHorse.Tooltips = (function () {
  const DEFINITIONS = {
    ...
    'Edge %'          : 'Edge percentage = Actual Win Rate − Implied Probability. Positive (green/right) means the market underestimates this odds bucket; negative (red/left) means it is over-backed.',
    'Implied Probability': 'Market-implied chance from odds (roughly 1 ÷ decimal odds). It is the crowd expectation before race outcome is known.',
    'ROI'             : 'Return on investment per race using flat stake. Positive ROI means profitable historically; negative ROI means losses.',
